...
clearBtn.addEventListener('click', () => {
  ...
  if (!logStream.querySelector('r-empty-state')) {
    const empty = document.createElement('r-empty-state')
    empty.setAttribute('variant', 'panel')
    empty.setAttribute('icon', '<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>')
