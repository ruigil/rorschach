...
import { closeWindow, focusWindow, setActiveWorkspaceTab, updateWindowState } from '@rorschach/frontend/webkit/window-actions.js';
...
export class RWindow extends RorschachBase {
  ...
  private _activeWindowIds = new StoreController<ShellState, 'activeWindowIds'>(this, ['shell', 'activeWindowIds']);
