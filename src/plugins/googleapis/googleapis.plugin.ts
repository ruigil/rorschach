  ...
  agents: {
    google: {
      ...
      options: (cfg) => ({
        ...
        agentSCRs: [
          'scr:leaf:googleapis.gmail_message_list',
          'scr:leaf:googleapis.gmail_message_get',
          'scr:leaf:googleapis.gmail_message_send',
          'scr:leaf:googleapis.gmail_search',
          'scr:leaf:googleapis.calendar_event_list',
          'scr:leaf:googleapis.calendar_event_create',
          'scr:leaf:googleapis.calendar_event_update',
          'scr:leaf:googleapis.calendar_event_delete',
          'scr:leaf:googleapis.drive_file_list',
          'scr:leaf:googleapis.drive_file_search',
          'scr:leaf:googleapis.drive_file_get',
          'scr:leaf:googleapis.drive_file_download',
          'scr:leaf:googleapis.drive_file_upload',
          'scr:leaf:googleapis.youtube_video_search',
          'scr:leaf:googleapis.youtube_video_details',
        ],
      }),
    },
  },
