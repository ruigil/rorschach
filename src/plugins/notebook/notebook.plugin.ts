...
import { createNotesActor, NOTES_CREATE_TOOL_NAME, NOTES_CREATE_SCHEMA, NOTES_UPDATE_TOOL_NAME, NOTES_UPDATE_SCHEMA, NOTES_READ_TOOL_NAME, NOTES_READ_SCHEMA, NOTES_LIST_TOOL_NAME, NOTES_LIST_SCHEMA, NOTES_SEARCH_TOOL_NAME, NOTES_SEARCH_SCHEMA, NOTES_ATTACH_IMAGE_TOOL_NAME, NOTES_ATTACH_IMAGE_SCHEMA } from './tools/notes.ts'
...
const buildToolCollection = (
  ...
  [NOTES_ATTACH_IMAGE_TOOL_NAME]:   { schema: NOTES_ATTACH_IMAGE_SCHEMA,   ref: notesRef   },
